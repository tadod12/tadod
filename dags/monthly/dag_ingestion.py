...
with DAG(
    ...
    start >> [download_yellow_taxi, download_green_taxi, download_fhv_taxi, download_fhvhv_taxi]
    download_yellow_taxi >> produce_yellow_taxi
    download_green_taxi >> produce_green_taxi
    download_fhv_taxi >> produce_fhv_taxi
    download_fhvhv_taxi >> produce_fhvhv_taxi
    [produce_yellow_taxi, produce_green_taxi, produce_fhv_taxi, produce_fhvhv_taxi] >> end
